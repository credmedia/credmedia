            ...
            <div key={video.id} className="relative group animate-in slide-in-from-bottom-10 duration-1000" style={{ animationDelay: `${idx * 200}ms` }}>
              ...
              <div className="relative bg-[#080808] border border-white/10 rounded-[2.5rem] overflow-hidden shadow-2xl">
                ...
                <div className="p-8">
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between pt-4 border-t border-white/5 gap-2">
                    <span className="text-white/30 text-[10px] font-bold">Having trouble loading the preview?</span>
                    <a 
                      href={`https://drive.google.com/file/d/${video.id}/view`} 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-brand-pink hover:text-brand-accent transition-colors text-[10px] font-black uppercase tracking-widest flex items-center gap-1.5 cursor-pointer"
                    >
